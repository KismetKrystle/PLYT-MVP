...
export const INTENT_META: Record<IntentName, {
    label: string;
    summary: string;
    accentClass: string;
    badgeClass: string;
    ...
    food_search: {
        label: 'Food Search',
        summary: 'Filtering ingredients and foods against your health profile.',
        accentClass: 'from-emerald-500 to-green-600',
        badgeClass: 'bg-emerald-50 text-emerald-700 border-emerald-200'
    },
    recipe_search: {
        label: 'Recipe Search',
        summary: 'Shaping this into a cookable answer with ingredients and steps.',
        accentClass: 'from-orange-500 to-amber-500',
        badgeClass: 'bg-orange-50 text-orange-700 border-orange-200'
    },
    health_advice: {
        label: 'Health Advice',
        summary: 'Balancing nutrition guidance with your conditions and preferences.',
        accentClass: 'from-sky-500 to-blue-600',
        badgeClass: 'bg-sky-50 text-sky-700 border-sky-200'
    },
    meal_suggestion: {
        label: 'Meal Suggestion',
        summary: 'Looking for practical meal options and nearby fit.',
        accentClass: 'from-lime-500 to-emerald-500',
        badgeClass: 'bg-lime-50 text-lime-700 border-lime-200'
    },
    research: {
        label: 'Research',
        summary: 'Gathering an evidence-aware answer with more nuance.',
        accentClass: 'from-violet-500 to-fuchsia-500',
        badgeClass: 'bg-violet-50 text-violet-700 border-violet-200'
    },
    library_action: {
        label: 'Library Action',
        summary: 'Checking whether this belongs in your saved knowledge and library flow.',
        accentClass: 'from-teal-500 to-cyan-500',
        badgeClass: 'bg-teal-50 text-teal-700 border-teal-200'
    },
    general: {
        label: 'General',
        summary: 'Pulling together the best response path.',
        accentClass: 'from-slate-500 to-gray-600',
